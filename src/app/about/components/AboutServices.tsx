...
const services = [
  {
    ...
    description: `Vendemos todo tipo de contenedores marítimos a precios muy competitivos en Medio Oriente. 
    ...
    image: "/images/services/trading.jpg",
    icon: FaBoxOpen,
  },
  {
    title: "Arrendamiento de Contenedores",
    description: `Poseemos más de 1000 contenedores para alquiler a corto y largo plazo, 
  ...
  },
  {
    ...
    description: `BoxHub brinda servicios de transporte en los EAU y desde los Emiratos hacia el CCG y el Levante. 
  ...
  },
  {
    ...
    description: `Nuestras instalaciones céntricas en Dubái brindan ventajas para el servicio de depósitos a empresas multinacionales de leasing y transporte marítimo. 
    ...
    image: "/images/services/depot.jpg",
    icon: FaTools,
  },
  {
    title: "Servicios de Inspección y Peritaje",
    description: `Los contenedores deben pasar por inspección y peritaje exhaustivo, exigido por el IICL, antes de poder ser utilizados. 
