  ...
  return (
    <section className="py-16 max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
      ...
      >
        ...
        <h3 className="text-xl font-semibold text-gray-800">Los 2 programas de inspección recomendados por la CSC:</h3>
        ...
        <p className="text-gray-600 leading-relaxed">
          <strong>Boxhub, tu solución integral para cumplimiento CSC:</strong> 
          Contamos con un equipo de inspectores certificados que revisan cada aspecto de la conformidad CSC e IISL para nuestros clientes. Te liberamos de papeleos y mantenimientos proporcionando los mejores servicios en Medio Oriente y Asia.
        </p>
      </motion.div>
    </section>
  );
